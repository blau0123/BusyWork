...
public class MedPriorityTodoAdapter extends
        RecyclerView.Adapter<MedPriorityTodoAdapter.ViewHolder> {
    // arraylist of notes to be shown in list
    private ArrayList<Todo> todo;
    MedPriorityTodoAdapter.ItemClicked activity;
     ...
     */
    public MedPriorityTodoAdapter(Context context, ArrayList<Todo> list){
        todo = list;
        activity = (MedPriorityTodoAdapter.ItemClicked) context;
    }
    ...
    */
    ...
    @NonNull
    @Override
    public MedPriorityTodoAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.todo_layout,
                viewGroup, false);
        return new MedPriorityTodoAdapter.ViewHolder(view);
    }
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull final MedPriorityTodoAdapter.ViewHolder viewHolder, int i) {
